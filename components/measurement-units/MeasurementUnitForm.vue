<template>
  <form @submit.prevent="submitForm" class="space-y-6">
    <div>
      <label for="name_ru" class="block text-sm font-medium text-gray-700">Наименование (RU)</label>
      <input type="text" v-model="formData.name_ru" id="name_ru" required
             class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    </div>
    <div>
      <label for="name_kz" class="block text-sm font-medium text-gray-700">Наименование (KZ)</label>
      <input type="text" v-model="formData.name_kz" id="name_kz" required
             class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    </div>
    <div>
      <label for="name_en" class="block text-sm font-medium text-gray-700">Наименование (EN)</label>
