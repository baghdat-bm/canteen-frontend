  ...
  <div class="bg-white p-6 rounded-lg shadow-md">
    ...
    >
      ...
      <template #row="{ item, index }">
        ...
        <td class="p-1"><input type="number" step="1" v-model.number="item.cost_price" :disabled="isViewMode" class="w-full p-2 border border-gray-400 rounded-md shadow-sm disabled:bg-gray-100" /></td>
        <td class="p-1"><input type="number" step="1" :value="item.amount" disabled class="w-full p-2 border border-gray-400 rounded-md shadow-sm bg-gray-100" /></td>
        <td class="p-1"><input type="number" step="1" :value="item.sale_price" @keydown.enter.prevent="addRow" class="w-full p-2 border border-gray-400 rounded-md shadow-sm disabled:bg-gray-100" /></td>
      </template>
    </DocumentItemsTable>
