...
export const useDishCategoriesStore = defineStore('dishCategories', () => {
    ...
    async function fetchRecords(page: number = 1, language?: string) {
        ...
        try {
            ...
            const response = await api.refs<PaginatedResponse<DishCategory>>(urlStr, { method: 'get' });
    ...
    async function fetchRecord(id: number) {
        ...
        isLoading.value = true;
        try {
            dishCategory.value = await api.refs<DishCategory>(`/dishes-categories/${id}/`, {method: 'get'});
        } catch (error) {            
            dishCategory.value = null;
    ...
    async function createRecord(payload: DishCategoryPayload) {
        ...
        try {
            await api.refs('/dishes-categories/', {
                method: 'post',
                body: formData,
            });
    ...
    async function updateRecord(id: number, payload: DishCategoryPayload) {
        ...
        try {
            ...
            await api.refs(`/dishes-categories/${id}/`, {
                method: 'patch',
                body: formData,
            });
