  ...
  <div class="container mx-auto">
          ...
          <tr v-for="unit in store.measurementUnits" :key="unit.id" @click="viewUnit(unit.id)"
            ...
            <td class="px-5 py-5 border-b border-gray-200 text-sm">
              ...
              <div class="flex items-center space-x-4">
                ...
                <button @click.stop="confirmDelete(unit)" class="text-red-600 hover:text-red-900">
    ...
    <div class="p-4">
      <ConfirmDialog v-model="showDeleteModal"
                     ...
                     :message="$t('measurementUnit.confirmDelete')"
...
import { useMeasurementUnitsStore, type MeasurementUnit } from '~/stores/measurementUnits';
...
const itemToDelete = ref<MeasurementUnit | null>(null);
...
const confirmDelete = (item: MeasurementUnit) => {
...
const deleteItemConfirmed = async () => {
  if (itemToDelete.value) {
    ...
    if (success) {
      store.measurementUnits = store.measurementUnits.filter(d => d.id !== itemToDelete.value?.id);
    }
  }
};
